...
$('#book-seat').on('click', function () {
  updateSelectedSeatsCount();
  confirm("You have selected ".concat(localStorage.length, " seats for a price of ").concat(selectedSeats.length * selectedMoviePrice));
});
...
/******/ });
//# sourceMappingURL=booking-21ec3c5c54812f02c1bd.js.map