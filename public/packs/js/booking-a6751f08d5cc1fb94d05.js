...
$('#book-seat').on('click', function () {
  updateSelectedSeatsCount();
  var selectedMoviePrice = localStorage.getItem('selectedMoviePrice');
  confirm("You have selected ".concat(localStorage.length, " seats for a price of ").concat(localStorage.length * selectedMoviePrice));
});
...
/******/ });
//# sourceMappingURL=booking-a6751f08d5cc1fb94d05.js.map