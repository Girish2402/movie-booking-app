...
$('#book-seat').on('click', function () {
  ...
  confirm("You have selected ".concat(selectedSeats.length, " seats for a price of ").concat(selectedSeats.length * selectedMoviePrice));
});
...
/******/ });
//# sourceMappingURL=booking-eb7b826e3d54a89a1248.js.map